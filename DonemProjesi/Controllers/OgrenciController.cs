...
namespace DonemProjesi.Controllers
{
    public class OgrenciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OgrenciID,OgrenciNumarasi,Ad,Soyad,Bolum,Sinif,Sifre")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OgrenciID,OgrenciNumarasi,Ad,Soyad,Bolum,Sinif,Sifre")] Ogrenci ogrenci)
        {
            if (ModelState.IsValid)
            {

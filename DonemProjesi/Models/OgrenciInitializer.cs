    ...
    public class OgrenciInitializer:DropCreateDatabaseIfModelChanges<OgrenciContext>  //Context'deki tablolarda bir değişiklik olursa silip en baştan yükler.
    {
        protected override void Seed(OgrenciContext context)   //seed metodu test verileri eklememizi sağlar
        {
            ...
            List<Ogrenci> ogrenciler = new List<Ogrenci>() {
                new Ogrenci(){OgrenciNumarasi=1, Ad="Buse", Soyad="Dokuzlar", Bolum="Bilgisayar Mühendisliği", Sinif=2,Yetenekler="c, java", Sifre="123", ProjeID=1},
                new Ogrenci(){OgrenciNumarasi=2, Ad="Halil Taşkın", Soyad="Karadeniz", Bolum="Makine Mühendisliği", Sinif=1,Yetenekler="c++, js",  Sifre="123", ProjeID=2},
                new Ogrenci(){OgrenciNumarasi=3, Ad="Süleyman Emre", Soyad="Akar", Bolum="Kimya Mühendisliği", Sinif=3,Yetenekler="python, sql",  Sifre="333", ProjeID=3},
                new Ogrenci(){OgrenciNumarasi=4, Ad="Ali", Soyad="Yılmaz", Bolum="Bilgisayar Mühendisliği", Sinif=2,Yetenekler="excel, c",  Sifre="abc", ProjeID=4}
            };
